...
namespace Ch07Ex01
{
    class Program
    {
...

        {
            ...
            indices[0] = 0;
            int count = 1;
            Debug.WriteLine(string.Format($"Maximum value initiailized to {maxVal}, at element index 0."));
            ...
            for (int i = 1; i < integers.Length; i++)
            {
                ...
                else
                {
                    if (integers[i] == maxVal)
                    {
                        ...
                        indices[count - 1] = i;
                        Debug.WriteLine(string.Format($"Duplicate Maximum value found at element index {i}. "));
                    }
                }
